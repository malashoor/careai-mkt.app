...
export default function SiteFooter({ locale, dict }: { locale: string; dict: any }) {
  return (
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <I18nLink href="/legal/privacy" locale={locale} className="text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
                  {dict.legal?.privacy || "Privacy"}
                </I18nLink>
              </li>
              <li>
                <I18nLink href="/legal/terms" locale={locale} className="text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
